    ...
    <>
      <div className="leftSideProfile pr-8 py-8 sticky">
        ...
        <div className=" flex flex-row justify-start align-middle mt-4 ">
          {/* <div className="flex justify-center rounded-full bg-gloomyPurple p-1">
              </div> */}
          <Image
            src={profilePic}
            alt="AuthorPic"
          ...
          <div className="flex flex-col self-center ml-5">
            <p className=" m-0 text-3xl text-veryDarkBlue">Ferdi Ferdiana</p>
            <p className="m-0 text-veryDarkBlue">@ferdianfh</p>
        ...
        <p className="m-0 mt-2 text-veryDarkBlue">
          I usually code in JavaScript, but sometimes i write articles to
          escape.
        </p>
